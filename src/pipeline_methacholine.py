# src/pipeline_methacholine.py
"""Ejecuta la extracción y transformación de metacolina."""

import argparse
from pathlib import Path

from src.extract.methacholine import extract_methacholine
...
def run_pipeline(
    ...
    analytical_dataframe = transform_methacholine(raw_dataframe)
    ...
    output_file = (
        OUTPUT_DIR
        / f"methacholine_analytics_{start_date}_{end_date}.parquet"
    )
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Extrae y transforma resultados de broncoprovocación con metacolina."
        )
    )
